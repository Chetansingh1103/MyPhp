  ...
  <div class="container-fluid">
    ...
    <div class="container my-3">
        ...
        <ul>
            ...
            <li>can only contain alphanumeric character and underscores</li>
            <li>Variables in php are case sensitive. ($chetan, $cHetan and $CHETAN are different)</li>
            <?php $name5 = "chetan"; echo $name5 ?>
        </ul>
      <p>
          <?php
